;;; color-theme-colorful-obsolescence.el --- Colorful Obsolescence theme designed for partially transparent windows

;; Author: Scott Jaderholm <jaderholm@gmail.com>
;; URL: http://jaderholm.com/color-themes/color-theme-colorful-obsolescence.el
;; Version: 0.0.1
;; Package-Requires: ((color-theme "6.6.1"))

;;; Commentary:

;; This theme is original and designed to be used in a partially transparent
;; window otherwise the background is very dark and the colors are very bright.
...
(defun color-theme-colorful-obsolescence ()
  ...
  (color-theme-install
   '(color-theme-colorful-obsolescence
     ...
     (default ((t (:stipple nil :background "black" :foreground "#bbb" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :width normal :foundry "outline" :family "Terminus"))))
     ...
     (completions-common-part ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#bbb" :background "black" :stipple nil :height 100))))
     ...
     (dired-perm-write ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#bbb" :background "black" :stipple nil :height 100))))
     (dired-symlink ((t (nil))))
     ...
     (egg-blame-culprit ((t (:family "Sans Serif" :background "grey15" :foreground "grey60"))))
     (egg-blame-subject ((t (:background "grey15" :family "Sans Serif" :foreground "white"))))
     (egg-branch ((t (:bold t :weight bold :family "Sans Serif" :foreground "Yellow"))))
     ...
     (egg-diff-file-header ((t (:bold t :weight bold :family "Sans Serif" :foreground "LightSlateBlue"))))
     ...
     (egg-header ((t (:bold t :family "Sans Serif" :weight bold))))
     ...
     (egg-help-header-2 ((t (:family "Sans Serif" :foreground "LightSteelBlue"))))
     (egg-help-key ((t (:bold t :foreground "Yellow" :weight bold))))
     ...
     (egg-section-title ((t (:bold t :weight bold :family "Sans Serif" :foreground "PaleGreen"))))
     ...
     (egg-text-2 ((t (:foreground "SteelBlue" :family "Sans Serif"))))
     (egg-text-3 ((t (:foreground "SteelBlue" :family "Sans Serif"))))
     (egg-text-4 ((t (:foreground "SteelBlue" :family "Sans Serif"))))
     ...
     (egg-text-help ((t (:foreground "SteelBlue" :family "Sans Serif"))))
     (egg-unmerged-diff-file-header ((t (:bold t :family "Sans Serif" :weight bold :foreground "Orange"))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "#008ed1" :italic t))))
     (font-lock-comment-face ((t (:foreground "#008ed1" :italic t))))
     ...
     (slime-inspector-topline-face ((t (:bold t :foreground "#ffff55" :weight bold))))
     ...
     (slime-repl-input-face ((t (:bold t :foreground "white" :weight bold))))
     ...
     (speedbar-directory-face ((t (:background "grey10" :foreground "grey50"))))
     ...
     (speedbar-selected-face ((t (:bold t :background "#777" :foreground "white" :weight bold))))
