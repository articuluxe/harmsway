...
(defun color-theme-black-purple ()
  ...
  (color-theme-install
   '(color-theme-black-purple
     ...
     (ac-selection-face ((t (:background "DarkCyan" :foreground "black" :weight bold))))
...
;drh     (ac-selection-face ((t (:background "steelblue" :foreground "white"))))
     ...
     (custom-visibility ((t (:underline t :foreground "cyan1"))))
     (diff-added ((t (nil))))
     (diff-changed ((t (nil))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "DeepPink4" :italic t))))
     (font-lock-comment-face ((t (:foreground "DeepPink4" :italic t))))
...
;     (font-lock-variable-name-face ((t (:foreground "White"))))
     (font-lock-variable-name-face ((t (:foreground "LightCyan1"))))
     ...
     (jabber-title-large ((t (:bold t :family "Sans Serif" :weight bold :width ultra-expanded))))
     (jabber-title-medium ((t (:bold t :family "Sans Serif" :weight bold :width expanded))))
     (jabber-title-small ((t (:bold t :family "Sans Serif" :weight bold :width semi-expanded))))
     ...
     (show-paren-match-face ((t (:foreground "lightblue1" :weight bold))))
     (show-paren-mismatch-face ((t (:background "IndianRed1" :foreground "white" :weight bold))))
