;;; creamsody-obsidian-theme.el --- Straight from the soda fountain
...
;;
;; Obsidian (almost black) version of creamsody.
;;
;;; Code:
...
(creamsody-deftheme creamsody-obsidian
 "Straight from the soda fountain."
 ((((class color) (min-colors #xFFFFFF)) ;; color column 1 GUI/24bit
   ((class color) (min-colors #xFF)))    ;; color column 2 Xterm/256

  (creamsody-background0_hard     "#0C0C0C" "#0C0C0C")
  (creamsody-background0          "#0C0C0C" "#0C0C0C")
 ...
 (custom-theme-set-variables 'creamsody-obsidian
...
(provide-theme 'creamsody-obsidian)

;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode 1))
;; End:

;;; creamsody-obsidian-theme.el ends here
