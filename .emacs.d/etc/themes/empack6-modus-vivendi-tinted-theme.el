...
;;;###theme-autoload
  (deftheme empack6-modus-vivendi-tinted
...
7:1 (WCAG AAA standard)."
  ...
  (defconst empack6-modus-vivendi-tinted-palette
    '(
;;; Basic values
...
;;;; Code mappings
      ...
      (builtin green-warmer);magenta-warmer)
      (comment red-faint)
      (constant blue-cooler)
      (docstring cyan-faint)
      (docmarkup yellow-faint);magenta-faint)
      (fnname green-intense);magenta)
      (keyword yellow-warmer);magenta-cooler)
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom empack6-modus-vivendi-tinted-palette-overrides nil
...
represents."
  ...
  (modus-themes-theme empack6-modus-vivendi-tinted
                      empack6-modus-vivendi-tinted-palette

                      empack6-modus-vivendi-tinted-palette-overrides)

  (provide-theme 'empack6-modus-vivendi-tinted))
