...
;; Copyright (C) 1997 -- 2010, 2015 Edward O'Connor <ted@oconnor.cx>
...
;; This file has been obsolete (and has not been updated) since I ported
;; my color theme to use Emacs' Custom Theme machinery; see
;; hober2-theme.el for the latest version.
...
speedbar, tex, view, viper, w3m, widget, woman"
 ...
 :bold t))))
     ...
     (font-lock-comment-face ((t (:foreground "medium orchid" :italic t))))
     (font-lock-comment-delimiter-face ((t (:foreground "dark orchid" :italic t))))
