...
;; Description      :
;;
;; Copyright © 2008, 2015 Manoj Srivastava <srivasta@debian.org
;;
...
(defun color-theme-manoj-font-lock ()
  ...
  (color-theme-install
   '(color-theme-manoj-font-lock
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "Salmon" :italic t))))
  ...
  (let ((color-theme-is-cumulative t))
    (color-theme-install
     '(color-theme-manoj-dark
       ...
       (completions-common-part ((t (:family "unknown-DejaVu Sans Mono" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "WhiteSmoke" :background "black" :stipple nil))))
       ...
       (mode-line ((t (:background "grey75" :foreground "Blue" :box (:line-width -1 :style released-button)))))
       (mode-line-buffer-id ((t (:background "grey65" :foreground "red" :bold t :weight bold))))
