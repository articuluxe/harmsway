...
;; Copyright (C) 1997 -- 2016 Edward O'Connor <ted@oconnor.cx>
...
(custom-theme-set-faces
 ...
 '(css-proprietary-property ((t (:foreground "light sea green"))))
 ...
 '(icomplete-first-match ((t (:foreground "cadet blue"))))
