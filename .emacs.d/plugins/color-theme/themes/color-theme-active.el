;;; color-theme-active.el --- Active theme inspired by jEdit theme of the same name

;; Author: Scott Jaderholm <jaderholm@gmail.com>
;; URL: http://jaderholm.com/color-themes/color-theme-active.el
;; Version: 0.0.1
...
(defun color-theme-active ()
  ...
  (color-theme-install
   '(color-theme-active
     ...
     (default ((t (:stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal))))
     ...
     (completions-common-part ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :height 120))))
     ...
     (dired-perm-write ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :height 100))))
     (dired-symlink ((t (:foreground "hotpink" :weight bold))))
     ...
     (egg-blame-culprit ((t (:family "Sans Serif" :background "grey85" :foreground "grey35"))))
     (egg-blame-subject ((t (:background "grey85" :family "Sans Serif" :foreground "black"))))
     (egg-branch ((t (:bold t :weight bold :family "Sans Serif" :foreground "SkyBlue"))))
     ...
     (egg-diff-file-header ((t (:bold t :weight bold :family "Sans Serif" :foreground "SlateBlue"))))
     ...
     (egg-help-header-2 ((t (:family "Sans Serif" :foreground "Black"))))
     (egg-help-key ((t (:bold t :foreground "SkyBlue" :weight bold))))
     ...
     (egg-section-title ((t (:bold t :weight bold :family "Sans Serif" :foreground "DarkGoldenrod"))))
     ...
     (egg-text-2 ((t (:foreground "navy" :family "Sans Serif"))))
     (egg-text-3 ((t (:foreground "navy" :family "Sans Serif"))))
     (egg-text-4 ((t (:foreground "navy" :family "Sans Serif"))))
     ...
     (egg-text-help ((t (:foreground "navy" :family "Sans Serif"))))
     (egg-unmerged-diff-file-header ((t (:bold t :family "Sans Serif" :weight bold :foreground "Red"))))
     (egg-warning ((t (:bold t :weight bold :foreground "Red"))))
     (emms-playlist-selected-face ((t (:inherit font-lock-function-name-face))))
     ...
     (font-lock-builtin-face ((t (:foreground "#505050"))))
     (font-lock-comment-delimiter-face ((t (:foreground "#009933" :italic t))))
     (font-lock-comment-face ((t (:foreground "#009933" :italic t))))
     ...
     (fringe ((t (:background "grey95" :foreground "grey60"))))
     ...
     (linum ((t (:background "grey90" :foreground "black" :weight normal :slant normal :underline nil))))
...
(add-to-list 'color-themes '(color-theme-active  "Active" "Scott Jaderholm <scott@jaderholm.com>"))

;;; color-theme-active.el ends here
