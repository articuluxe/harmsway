...
(defun color-theme-wombat+ ()
  ...
  (color-theme-install
   '(color-theme-wombat+
     ...
     (custom-group-tag ((t (:bold t :family "Sans Serif" :foreground "light blue" :weight bold))))
     (custom-group-tag-1 ((t (:bold t :family "Sans Serif" :foreground "pink" :weight bold))))
     ...
     (custom-visibility ((t (:bold t :weight bold :underline t :foreground "#8ac6f2"))))
     ...
     (dired-perm-write ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#f6f3e8" :background "#242424" :stipple nil :height 100))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "#99968b" :italic t))))
...
;orig     (mode-line ((t (:background "grey75" :foreground "black" :box (:line-width -1 :style released-button)))))
...
;orig     (mode-line-inactive ((t (:background "grey30" :foreground "grey80" :box (:line-width -1 :color "grey40" :style nil) :weight light))))
     (mode-line-inactive ((t (:background "grey20" :foreground "black" :box (:line-width -1 :color "grey40" :style nil) :weight light))))
     (mouse ((t (nil))))
     ...
     (tabbar-default ((t (:inherit nil :stipple nil :background "#303030" :foreground "black" :box nil :strike-through nil :underline nil :slant normal :weight normal :width normal :family "Lucida Grande"))))
     ...
     (tabbar-selected-modified ((t (:inherit tabbar-selected :weight thin))))
