...
(defvar mandm-colors-alist
  `(("mandm-fg+2"     . ,(color-lighten-name mmfg-color 22))
    ...
    ("mandm-orange-2" . ,(color-darken-name mmorange-color 20))
    ("mandm-orange-3" . ,(color-darken-name mmorange-color 30))
    ("mandm-orange-4" . ,(color-darken-name mmorange-color 40))
    ("mandm-orange-5" . ,(color-darken-name mmorange-color 50))
    ...
    ("mandm-green-5"  . ,(color-darken-name mmgreen-color 30))
    ...
    ("mandm-blue-6"   . ,(color-darken-name mmblue-color 30))
    ("mandm-blue-7"   . ,(color-darken-name mmblue-color 40))
    ("mandm-blue-8"   . ,(color-darken-name mmblue-color 50))
...
;;;;; basic coloring
   ...
   `(link ((t (:foreground ,mandm-blue+1 :underline t :weight bold))))
...
;;;;; diff
   `(diff-added ((,class (:foreground ,mandm-green+4 :background unspecified))
                 (t (:foreground ,mandm-green-1 :background unspecified))))
   `(diff-changed ((t (:foreground ,mandm-yellow))))
   `(diff-removed ((,class (:foreground ,mandm-red :background unspecified))
                   (t (:foreground ,mandm-red-3 :background unspecified))))
...
;;;;; mu4e
   `(mu4e-unread-face ((t (:bold t :foreground ,mandm-blue+3))))
;;;;; gnus
...
;;;;; proofgeneral
   ...
   `(proof-tacticals-name-face ((t (:inherit font-lock-constant-face :foreground unspecified :background ,mandm-bg))))
   `(proof-tactics-name-face ((t (:inherit font-lock-constant-face :foreground unspecified :background ,mandm-bg))))
