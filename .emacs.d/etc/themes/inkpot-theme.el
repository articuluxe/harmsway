...
(let
  ...
  (custom-theme-set-faces 'inkpot
    ...
    `
    (header-line
      ((t (:foreground ,ip-grey+73 :background ,ip-slate-dark+15.7 :bold t ,@box-outline))))
    `
    (header-line-inactive
      ((t (:foreground ,ip-grey+73 :background ,ip-slate-dark+15.7 ,@box-outline))))
    ...
    (tab-bar-tab-inactive
      ((t (:foreground ,ip-grey+73 :background ,ip-slate-dark+15.7 :bold nil :italic t))))
    ...
    (ediff-fine-diff-Ancestor
      ((t (:foreground ,ip-cream-light :background ,ip-red-light weight bold))))
    `
    (ediff-fine-diff-B
      ((t (:foreground ,ip-cream-light :background ,ip-green-bright :weight bold))))
    ...
    (fancy-dabbrev-preview-face
      ((t (:foreground ,ip-slate-light+5.5 :background ,ip-slate-dark+7.6))))
