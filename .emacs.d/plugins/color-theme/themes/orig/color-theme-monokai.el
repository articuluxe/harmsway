...
;;
;; Copyright (C) 2010, 2015 Operator <rectifier04@gmail.com>
;;
...
Based on the TextMate theme Monokai"
  ...
  (color-theme-install
   '(color-theme-monokai
     ...
     (default ((t (nil))))
     (font-lock-comment-face ((t (:foreground "#75715E" :italic t)))) ; dark aluminum
     (font-lock-comment-delimiter-face ((t (:foreground "#75715E" :italic t)))) ; dark aluminum
