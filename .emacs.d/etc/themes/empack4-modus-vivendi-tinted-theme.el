;;; Elegant, highly legible theme with a night sky background -*- lexical-binding:t -*-
...
;;;###theme-autoload
  (deftheme empack4-modus-vivendi-tinted
...
7:1 (WCAG AAA standard)."
  ...
  (defconst empack4-modus-vivendi-tinted-palette
    '(
;;; Basic values
...
(bg-inactive          "#ad4c3c")
(border          "#7c4130")
(fg-main          green-warmer);"#b99a8d")
(fg-dim          "#4f3423")
(fg-alt          magenta-warmer);"#595c49")
...
;;;; General mappings
      ...
      (name nuanced-blue);magenta)
      (identifier yellow-intense)
...
;;;; Code mappings
      ...
      (docmarkup yellow-faint);magenta-faint)
      (fnname blue-warmer);magenta)
      (keyword yellow-intense);magenta-cooler)
      (preprocessor yellow-cooler) ;red-cooler)
      (string blue-warmer)
      (type cyan-cooler)
      (variable cyan)
      (rx-construct green-cooler)
      (rx-backslash green-warmer);magenta)
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom empack4-modus-vivendi-tinted-palette-overrides nil
...
represents."
  ...
  (modus-themes-theme empack4-modus-vivendi-tinted
                      empack4-modus-vivendi-tinted-palette

                      empack4-modus-vivendi-tinted-palette-overrides)

  (provide-theme 'empack4-modus-vivendi-tinted))
