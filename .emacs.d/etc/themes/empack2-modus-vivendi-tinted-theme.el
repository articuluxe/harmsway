...
;;;###theme-autoload
  (deftheme empack2-modus-vivendi-tinted
...
7:1 (WCAG AAA standard)."
  ...
  (defconst empack2-modus-vivendi-tinted-palette
    '(
;;; Basic values
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom empack2-modus-vivendi-tinted-palette-overrides nil
...
represents."
  ...
  (modus-themes-theme empack2-modus-vivendi-tinted
                      empack2-modus-vivendi-tinted-palette

                      empack2-modus-vivendi-tinted-palette-overrides)

  (provide-theme 'empack2-modus-vivendi-tinted))
