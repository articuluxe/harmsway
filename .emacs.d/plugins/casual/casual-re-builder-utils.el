...
(defgroup casual-re-builder nil
  "Settings for Casual RE-Builder."
  :group 'casual)

(defcustom casual-re-builder-add-extra-keybindings t
  "If non-nil then extra module-specific keybindings will be set.

See `casual-re-builder-setup' for more detail for said keybindings."
  :type 'boolean
  :group 'casual-re-builder)
