...
;; Copyright (C) 2011, 2012, 2013, 2015, Julien Barnier <julien@nozav.org>
...
;;drh     (isearch ((t (:background "#f57900" :foreground "#2e3436"))))
     (isearch ((t (:background "#f57900" :foreground "#fce94f"))))
