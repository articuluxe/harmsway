...
;;;###theme-autoload
  (deftheme empack5-modus-vivendi-tinted
...
7:1 (WCAG AAA standard)."
  ...
  (defconst empack5-modus-vivendi-tinted-palette
    '(
;;; Basic values
...
;;;; Code mappings
      ...
      (keyword red-intense);magenta-cooler)
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom empack5-modus-vivendi-tinted-palette-overrides nil
...
represents."
  ...
  (modus-themes-theme empack5-modus-vivendi-tinted
                      empack5-modus-vivendi-tinted-palette

                      empack5-modus-vivendi-tinted-palette-overrides)

  (provide-theme 'empack5-modus-vivendi-tinted))
