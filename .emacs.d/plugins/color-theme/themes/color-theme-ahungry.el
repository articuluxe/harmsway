...
(defun color-theme-ahungry ()
  ...
  (color-theme-install
   '(color-theme-ahungry
     ...
     (org-level-1 ((t (:bold t :foreground "#4477ff"))))
     (org-level-2 ((t (:bold nil :foreground "#ffc800"))))
     (org-level-3 ((t (:bold t :foreground "#00aa33"))))
     (org-level-4 ((t (:bold nil :foreground "#f68585"))))
