...
;;;###theme-autoload
  (deftheme empack3-modus-vivendi-tinted
...
7:1 (WCAG AAA standard)."
  ...
  (defconst empack3-modus-vivendi-tinted-palette
    '(
;;; Basic values
...
;;;; Code mappings
      ...
      (comment green-cooler) ;;red-faint)
...
exists in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom empack3-modus-vivendi-tinted-palette-overrides nil
...
represents."
  ...
  (modus-themes-theme empack3-modus-vivendi-tinted
                      empack3-modus-vivendi-tinted-palette

                      empack3-modus-vivendi-tinted-palette-overrides)

  (provide-theme 'empack3-modus-vivendi-tinted))
