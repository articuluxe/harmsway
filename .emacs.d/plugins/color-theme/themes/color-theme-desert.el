  ...
  (color-theme-install
   (append
    (list 'color-theme-desert
          ...
          `(font-lock-comment-face ((t (:foreground ,desert-comment-fg :italic t))))
          `(font-lock-comment-delimiter-face ((t (:foreground ,desert-comment-fg :italic t))))
          ...
          `(show-paren-mismatch ((t (:foreground ,desert-fixme-bg :background ,desert-fixme-fg :bold t))))
          `(show-paren-match ((t (:foreground ,desert-hl-fg :background ,desert-hl-bg :bold t))))
