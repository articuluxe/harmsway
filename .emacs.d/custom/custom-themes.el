...
(defun harmsway/after-load-theme (x)
  ...
  (let ((sym (intern x)))
    ...
    (cond ((eq sym 'adwaita)
          ...
          ((memq sym '(almost-mono-black almost-mono-cream
                                         almost-mono-gray almost-mono-white))
           (custom-theme-set-faces sym '(show-paren-match ((t (:bold t :background "#00ff00")))))
          ...
          ((eq sym 'soothe)
           (harmsway/make-comment-delimiter-face-same-as-comment-face sym))
          ((eq sym 'spaceink)
           (custom-theme-set-faces sym '(cursor ((t (:background "#fff171"))))))
          ((eq sym 'sourcerer)
           (custom-theme-set-faces sym '(cursor ((t (:background "yellow3"))))))
          ((eq sym 'srcery)
