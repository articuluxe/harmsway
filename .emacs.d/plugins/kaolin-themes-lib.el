...
(defconst kaolin-faces
  `(
    ...
    (nerd-icons-red      (:foreground kaolin-red))
   ...
   ;;  (nerd-icons-yellow   (:foreground yellow3))
    ...
    (nerd-icons-blue     (:foreground kaolin-blue))
    ;; (nerd-icons-blue-alt (:foreground capri1))
    (nerd-icons-blue-alt (:foreground kaolin-navy))
    ...
    (nerd-icons-purple   (:foreground kaolin-magenta))
    ...
    (nerd-icons-cyan     (:foreground kaolin-cyan))
